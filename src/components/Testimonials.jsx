...
const Testimonials = () => {
    return (
        ...
        <div className='container pt-5'>
            ...
            <p className='text-center pt-5'> <button className='works'>Testimonials</button> </p>
            <h1 className='wocs text-center'>What our customers say</h1>
            <p className='sit text-center'>Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
            </div>
...
<p className='mx-3'> <img className='ppl' src="/images/people1.svg" alt="" />   <h1 className='nm'>Orlando Diggs</h1>  <p className='prf'>Photographer</p>   </p>
...
<p className='mx-3'> <img className='ppl' src="/images/people2.svg" alt="" />   <h1 className='nm'>Mollie Hall</h1>  <p className='prf'>Biologist</p>   </p>
...
<p className='mx-3'> <img className='ppl' src="/images/people3.svg" alt="" />   <h1 className='nm'>Lori Bryson</h1>  <p className='prf'>Blogger</p>   </p>
...
<p className='mx-3'> <img className='ppl' src="/images/people4.svg" alt="" />   <h1 className='nm'>Kate Morrison</h1>  <p className='prf'>Makeup Artist</p>   </p>
...
<p className='mx-3'> <img className='ppl' src="/images/people5.svg" alt="" />   <h1 className='nm'>Koray Okumus</h1>  <p className='prf'>Writter</p>   </p>
...
<p className='mx-3'> <img className='ppl' src="/images/people6.svg" alt="" />   <h1 className='nm'>Noah Pierre</h1>  <p className='prf'>Dermatologist</p>   </p>
